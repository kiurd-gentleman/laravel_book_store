                                ...
                                <table>
                                    ...
                                    @foreach($cartItem as $item)
                                        <tr>
                                            ...
                                            @foreach(App\Models\productImage::where('product_id',$item->product_id)->get() as $image)
                                                @if($i>0)
                                            <td class="product-thumbnail"><a href="#"><img src="{{asset($image->product_image)}}" alt="product img" /></a></td>
                                                @endif
                                                @php $i=0 ; $x = $x++ @endphp
                                            @endforeach
                                            <td class="product-name"><a href="#">{{$item->product_name}}</a>
                                                <ul  class="pro__prize">
                                                    <li class="old__prize">$82.5</li>
                                                    <li>$75.2</li>
                                                </ul>
                                            </td>
                                            <td class="product-price"><span class="amount">TK: {{$item->price}}</span></td>
                                            <td class="product-quantity">
                                            	<input type="hidden" name="id[]" value="{{ $item->id }}">
                                            	<input name="quantity[]" type="number" value="{{$item->quantity}}" /><input type="hidden" name="id{{$x}}" value="{{$item->id}}"></td>
                                            <td class="product-subtotal">TK: {{$item->total_price}}</td>
                                            <td class="product-remove"><a href="{{route('product.remove' ,$item->id)}}"><i class="icon-trash icons"></i></a></td>
                                        </tr>
                                        @endforeach
                                        {{--<tr>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        <div class="buttons-cart">
                                            <a href="{{route('home.product-grid')}}">Continue Shopping</a>
                                        </div>
