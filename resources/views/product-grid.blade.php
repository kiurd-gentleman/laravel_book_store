                                ...
                                <div class="shop__grid__view__wrap">
                                    <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix">
                                        ...
                                        <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                                            <div class="category">
                                                <div class="ht__cat__thumb" style="height: 200px; width: 341px;">
                                                    <a href="{{route('home.product-details', $product->id)}}">
                                                        @php $i =1;@endphp
                                                        @foreach($product->images as $image)
                                                            @if($i>0)
                                                                <img src="{{asset($image->product_image)}}" alt="product images" style="height: 200px; width: 341px;">
                                                            @endif
                                                            @php $i--; @endphp
                                                        @endforeach
                                                    </a>
                                                ...
                                                <div class="fr__hover__info">
                                                    <ul class="product__action">
                                                        ...
                                                        <li><a href="{{route('product.addToCart' , $product->id)}}"><i class="icon-handbag icons"></i></a></li>

                                                        <li><a href="#"><i class="icon-shuffle icons"></i></a></li>
                                                    </ul>
                                                </div>
                                                <div class="fr__product__inner">
                                                    <h4><a href="{{route('home.product-details', $product->id)}}">{{$product->product_name}}</a></h4>
                                            ...
                                            <div class="ht__list__wrap">
                                                ...
                                                <div class="ht__list__product">
                                                    <div class="ht__list__thumb">
                                                        ...
                                                        @foreach($product->images as $image)
                                                            @if($i>0)
                                                                <a href="product-details.html"><img src="{{asset($image->product_image)}}" alt="product images"></a>
                                                            @endif
                                                            @php $i--; @endphp
                                                        @endforeach
                                                    ...
                                                    <div class="htc__list__details">
                                                        ...
                                                        <div class="fr__list__btn">
                                                            <a class="fr__btn" href="{{route('product.addToCart' , $product->id)}}">Add To Cart</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
