        ...
        <div class="container-fluid">
            ...
            <div class="container">
                <div class="card card-product mx-auto mt-5">
                    <h3><div class="card-header text-center" style="font-weight: bold">Product edit</div></h3>
                    <div class="row justify-content-center">
                        <div class="col-6">
                            @include('admin.error-display')

                            <form method="post" enctype="multipart/form-data" action="{{route('admin.edit.submit', $product->id)}}">
                                {{csrf_field()}}

                                <div class="form-group">
                                    <label for="book-name">Book Name</label>
                                    <input type="text" class="form-control" id="book-name" name="product_name" value="{{$product->product_name}}" >
                                </div>
                               {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="book-details" name="product_details" value="{{$product->description}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="book-quantity" name="product_quantity" value="{{$product->quantity}}">
                                </div>
                                <div class="form-group">
                                    <label for="book-price">Price</label>
                                    <input type="number" class="form-control" id="book-price" name="product_price" value="{{$product->price}}">
                                </div>
                                <div class="form-group">
                                    <label for="book-price">Status</label>
                                    <input type="number" class="form-control" id="book-price" name="product_status" value="{{$product->status}}">
                                </div>
                                <div class="form-group">
                                    <label for="book-price">offer-price</label>
                                    <input type="number" class="form-control" id="book-price" name="offer_price" value="{{$product->offer_price}}">
                                </div>
