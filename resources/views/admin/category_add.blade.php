                        ...
                        <div class="col-6">
                            ...
                            <form method="post" enctype="multipart/form-data" action="{{route('admin.category.store')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="book-name" name="category_name" value="" >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="book-price" name="created_at" value="">
                                </div>
                                <div class="form-group">
                                    <label for="book-price">Updated date</label>
                                    <input type="text" class="form-control" id="book-price" name="updated_at" value="">
                                </div>
