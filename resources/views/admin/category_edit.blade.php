                ...
                <div class="card card-product mx-auto mt-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6">
                            ...
                            <form method="post" enctype="multipart/form-data" action="{{route('admin.category.edit.submit', $category->id)}}">
                                {{csrf_field()}}

                                <div class="form-group">
                                    <label for="book-name">Category Name</label>
                                    <input type="text" class="form-control" id="book-name" name="category_name" value="{{$category->category_name}}" >
                                </div>
                                <div class="form-group">
                                    <label for="book-title">Parent ID</label>
                                    <br>
                                    <select class="form-control" name="category_id" >
                                        @if($category->parent_id == null)
                                            <option value="">Primary category</option>
                                        @else
                                            <option value="{{$category->parent->id}}">{{$category->parent->category_name}}</option>
                                        @endif
                                ...
                                <div class="form-group">
                                    <label for="book-price">Created date</label>
                                    <input type="text" class="form-control" id="book-price" name="created_at" value="{{$category->created_at}}">
                                </div>
                                <div class="form-group">
                                    <label for="book-price">Updated date</label>
                                    <input type="text" class="form-control" id="book-price" name="updated_at" value="{{$category->updated_at}}">
                                </div>
