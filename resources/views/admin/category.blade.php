  ...
  <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                  ...
                  <a class="dropdown-item" href="{{route('admin.products')}}">Show all product</a>
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                  <!-- <h6 class="dropdown-header">LoginController Screens:</h6>-->
                  <a class="dropdown-item" href="{{route('admin.category')}}">Show Category</a>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
          <div class="card mb-3" style="color: darkred">
              <div class="card-header" >
                  <i class="fas fa-table"></i>
                  Data Table Example</div>
              <div class="card-body">
                  <div class="table-responsive" >
                      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="border: yellow">
                          <thead>
                          ...
                          <tbody style="background-color: #e6e8da91;">
                          @foreach($categories as $category)
                              <tr>
                                  ...
                                  <td><a class="btn btn-outline-success" href="{{route('admin.category.edit' ,$category->id )}}" style="width: 40px;"><i class="fas fa-edit"></i></a>
                                      <a class="btn btn-outline-danger" data-toggle="modal" href="#deleteModal{{$category->id}}" style="margin-left: 10px;"><i class="fas fa-trash-alt"></i></a></td>

                                  {{--//delete modal--}}
                                  <div class="modal fade" id="deleteModal{{$category->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                              <div class="modal-header">
                                                  <h5 class="modal-title" id="staticBackdropLabel">Product delete permission</h5>
                                              ...
                                              <div class="modal-body">
                                                  <form method="post" action="{{route('admin.category.delete', $category->id)}}">
                                                      ...
                                                      <button type="submit" class="btn btn-danger" style="float: right;width: 466px;">Continue</button>
                                                  </form>
                                              </div>
                                          </div>
                                      </div>
