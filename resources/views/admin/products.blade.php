                        ...
                        @foreach($products as $product)
                          ...
                          <tr>
                            ...
                            <td>{{$product->update_at}}</td>
                              <td><a class="btn btn-outline-success" href="{{route('admin.product.edit' ,$product->id )}}" style="width: 40px;"><i class="fas fa-edit"></i></a>
                                  <a class="btn btn-outline-danger" data-toggle="modal" href="#deleteModal{{$product->id}}"><i class="fas fa-trash-alt"></i></a></td>

                              //delete modal
                              <div class="modal fade" id="deleteModal{{$product->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              <form method="post" action="{{route('admin.submit.delete', $product->id)}}">
                                                  {{csrf_field()}}
                                                  <p>Are you sure to delete this product?</p>
                                                  <button type="submit" class="btn btn-danger" style="float: right;">Continue</button>
                                              </form>
                                          </div>
